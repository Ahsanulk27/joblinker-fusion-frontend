...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            ...
            <AnimatedElement animation="slide-in" delay={200}>
              <h1 className="font-bold mb-6 leading-tight">
                Find Your Dream Job or <span className="text-brand-red">Hire Top Talent</span>
              </h1>
            </AnimatedElement>
            
            <AnimatedElement animation="slide-in" delay={400}>
              <p className="text-lg text-muted-foreground mb-8 max-w-lg">
                JobLinker empowers professionals to advance their careers and helps companies 
                discover perfect talent matches through our AI-powered platform.
              </p>
            </AnimatedElement>
              ...
              <div className="w-full h-96 sm:h-[450px] rounded-2xl bg-gradient-to-br from-brand-red to-brand-tangerine shadow-xl relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-8">
                    <div className="text-white text-2xl font-bold">Ready to take the next step?</div>
                    <p className="text-white/90 mt-2">Thousands of opportunities await.</p>
                  </div>
                </div>
              </div>
            </AnimatedElement>
      ...
      {/* Keep rest of the sections unchanged */}
      {/* Stats Section */}
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <AnimatedElement>
            <h2 className="text-center mb-12">Trusted by Professionals & Businesses</h2>
          </AnimatedElement>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {jobStats.map((stat, index) => (
              <AnimatedElement key={stat.id} delay={index * 100} animation="scale-in">
        ...
        <div className="container mx-auto px-4">
          <AnimatedElement>
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Top employers across industries trust JobLinker to find their perfect talent match
              </p>
            </div>
          </AnimatedElement>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {featuredCompanies.map((company, index) => (
              <AnimatedElement key={company.id} delay={index * 100} animation="fade-in">
        ...
        <div className="container mx-auto px-4">
          <AnimatedElement>
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our AI-powered platform makes finding the right job or candidate simpler than ever
              </p>
            </div>
          </AnimatedElement>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: "Get Matched",
                description: "Our AI analyzes your profile to recommend the most suitable job opportunities.",
                icon: "🔄",
              },
              {
                title: "Apply & Connect",
                description: "Apply to jobs with a single click and communicate directly with employers.",
                icon: "✅",
              },
            ].map((step, index) => (
              <AnimatedElement key={index} delay={index * 200} animation="slide-in">
        ...
        <div className="container mx-auto px-4 text-center text-white">
          <AnimatedElement>
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
              Join thousands of professionals who have found their dream job through JobLinker.
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-white/70 mb-4">
                Connecting the right talent with the right opportunities. The future of job searching is here.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/jobs" className="text-white/70 hover:text-white">Browse Jobs</Link></li>
                <li><Link to="/career-resources" className="text-white/70 hover:text-white">Career Resources</Link></li>
                <li><Link to="/resume-builder" className="text-white/70 hover:text-white">Resume Builder</Link></li>
                <li><Link to="/salary-insights" className="text-white/70 hover:text-white">Salary Insights</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/post-job" className="text-white/70 hover:text-white">Post a Job</Link></li>
                <li><Link to="/talent-search" className="text-white/70 hover:text-white">Talent Search</Link></li>
                <li><Link to="/employer-branding" className="text-white/70 hover:text-white">Employer Branding</Link></li>
