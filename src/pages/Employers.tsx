      ...
      <main className="flex-grow pt-20">
        ...
        <section className="py-16 bg-muted/50">
          <div className="container mx-auto px-4 text-center">
            <AnimatedElement>
              <h2 className="text-3xl font-bold mb-4">Flexible plans for every hiring need</h2>
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Whether you're a startup making your first hire or an enterprise with ongoing recruitment needs, we have a plan for you.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {[
                  ...
                  <Card key={index} className={index === 1 ? "border-brand-red shadow-lg" : ""}>
                    <CardHeader>
                    ...
                    <div className="px-6 pb-6">
                      <Button className={`w-full ${index === 1 ? "bg-brand-red hover:bg-brand-red/90" : ""}`}>
                        Get Started
                      </Button>
                    </div>
                  </Card>
